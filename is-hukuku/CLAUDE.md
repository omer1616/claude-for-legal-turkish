...
2. O dosya yoksa veya hâlâ [YER_TUTUCU] işaretleri içeriyorsa, esaslı işe başlamadan
   ...
   gerekiyor. /is-hukuku:ilk-kurulum çalıştır — yaklaşık 10-15 dakika sürer ve bu
   ...
   devam ETME. Kurulumsuz çalışan tek skill'ler /is-hukuku:ilk-kurulum'un kendisi ve
...
4. Bir eklenti güncellemesinden sonraki ilk çalıştırmada, eski önbellek yolunda dolu bir
   CLAUDE.md varsa
   (~/.claude/plugins/cache/claude-for-legal-turkish/is-hukuku/<sürüm>/CLAUDE.md, herhangi bir sürüm için)
...
**Kalıcı veri yolu.** İzin kaydı, soruşturma günlükleri ve genişleme izleyicileri
`~/.claude/plugins/config/claude-for-legal-turkish/is-hukuku/` altına yazılır — eklenti
güncellemelerinden etkilenmeyen bir yol. Bu dosyalar meslek sırrı kapsamında ve hassas
özlük bilgisi içerir — bu dizinin yedeklendiğinden ve erişiminin kontrollü olduğundan
emin olun.
-->

# İş Hukuku Pratik Profili
*İlk-kurulum tarafından [TARİH]'te yazıldı. Aşağıda `[YER_TUTUCU]` görünüyorsa
`/is-hukuku:ilk-kurulum` çalıştır.*
...
*Ekip düzeyi bağlam — aşağıdaki bölümlerden ayrı tutulur. Bu bölümü başka bir
`-hukuku` eklentisinde doldurduysan, yeniden girmek yerine buraya kopyala.*

[Şirket adı]. Çalışan sayısı: [N]. İK sorumlusu: [isim]. İş hukuku danışmanı:
[siz / dış avukat / ikisi de].

*(Şirket adı ve çalışan sayısı company-profile.md'den gelir — tüm eklentilerde
değiştirmek için orada düzenle. İK sorumlusu ve danışman bu eklentiye özgüdür.)*
...
*Skill'ler bu bölümü iş-ürünü başlığını seçmek ve sonuç doğuran eylemleri kapıya
almak (aşağıdaki `## Çıktılar` ve skill başına kapılara bakın) için okur.*
...
|---|---|---|
| İK sistemi (HRIS — SAP SuccessFactors, Logo, Netsis, Workday vb.) | [YER_TUTUCU ✓/✗] | İzin verisi `~/.claude/plugins/config/claude-for-legal-turkish/is-hukuku/izin-kaydi.yaml` dosyasında tutulur; `/is-hukuku:izin-kaydi` ile elle giriş |
| Belge depolama (Google Drive, SharePoint, Box) | [YER_TUTUCU ✓/✗] | Çalışma kılavuzu ve tohum belgeler için yerel yollar okunur |
| Slack | [YER_TUTUCU ✓/✗] | İncelemeler yalnızca dosya olarak üretilir; kanal içi özet yok |

*Yeniden kontrol: `/is-hukuku:ilk-kurulum --check-integrations`*
...
kaydet. `~/.claude/plugins/config/claude-for-legal-turkish/is-hukuku/verification-log.md`
...
- Daha iyisini yapacak yapılandırılmış bir skill varsa öner: "Bu hızlı bir cevap. Tam
  çerçeveyi istersen `/is-hukuku:[ilgili skill]` çalıştır."

Pratik profili dolu değilse: "Genel bir cevap verebilirim ama bu eklenti pratiğine
göre yapılandırıldığında çok daha iyi cevaplar verir — `/is-hukuku:ilk-kurulum`
...
`/is-hukuku:dosya-calisma-alani` size gerekmez.*
...
`/is-hukuku:dosya-calisma-alani new | list | switch | close | none` ile yönet.

---

## Hukukçu olmayan çıktı modu (bu eklentiye özgü)

Pratik profili kullanıcının avukat olmadığını söylediğinde, çıktıları hukuki
kısayolları çözemeyen bir okuyucu için yapılandır: (1) avukata özet en üstte,
gömülü değil, (2) her hukuki işaret parantez içinde tek satırlık sade-Türkçe
açıklama alır, (3) her kanun atfı sade-Türkçe bir konu başlığı alır. Örnek:
"İşaret: olası kıdem tazminatı hesap hatası (4857 sayılı Kanun m.120, mülga
1475 sayılı Kanun m.14 atfı) — kıdem tazminatı her tam yıl için 30 günlük
ücret üzerinden hesaplanır `[doğrulanacak]`." Test: okuyucu çıktıyı patronuna
odada avukat olmadan götürüp açıklayabilir mi?

## Yargı çevresi ayak izi

**Türkiye'de çalışan sayısı:** [YER_TUTUCU]
**Sektöre göre uygulanacak rejim:** [YER_TUTUCU — çoğunlukla 4857 sayılı İş
Kanunu; deniz taşımacılığı için 854 sayılı Deniz İş Kanunu, gazetecilik için
5953 sayılı Basın İş Kanunu, tarım/ev hizmetleri gibi 4857 m.4 kapsam dışı
işler için Türk Borçlar Kanunu genel hükümleri geçerli olabilir
`[doğrulanacak — sektöre göre teyit edilmeli]`]
**Yurt dışında çalışanı olan ülkeler:** [YER_TUTUCU — liste; `/is-hukuku:uluslararasi-genisletme` bu listeyi besler]
**Uzaktan / ofis merkezli:** [YER_TUTUCU]
**Toplu iş sözleşmesi kapsamı:** [YER_TUTUCU — sendikalı işyeri var mı, hangi
sendika, hangi işkolu `[doğrulanacak]`]

**Yüksek dikkat gerektiren alanlar** (en çok çalışan, en dar yorumlanan kural,
veya geçmişte sorun çıkan alan):
- [YER_TUTUCU — ör. "İstanbul merkez ofis", "saha satış ekibi (fazla mesai riski)"]

*(ABD kaynak plugin'de bu bölüm eyalet-eyalet farkını haritalıyordu — Türkiye'de
iş hukuku büyük ölçüde ulusal düzeyde tektir; asıl varyasyon sektöre göre
uygulanacak rejimden ve yurt dışı şubelerden gelir. Bu yüzden tablo o eksene
göre yeniden çerçevelendi.)*

---

## İşe alım incelemesi

**Hukuk ne zaman işe alımı inceler:** [YER_TUTUCU — tüm teklifler / yalnızca
üst düzey / yalnızca rekabet yasağı içerenler]

**Teklif mektubu şablonu:** [YER_TUTUCU — konum]
**Rekabet yasağı politikası:** [YER_TUTUCU — 4857 ve TBK m.444-447 kapsamında
hangi pozisyonlarda kullanılıyor, süre ve coğrafi kapsam sınırları
`[doğrulanacak]`]
**Ayrımcılık yasağı kontrolü:** [YER_TUTUCU — 4857 m.5 eşit davranma ilkesi
kontrolü işe alım metninde nasıl uygulanıyor]
**Engelli/eski hükümlü kotası:** [YER_TUTUCU — 4857 m.30 kapsamında şirketin
kota yükümlülüğü var mı, mevcut durum `[doğrulanacak — otomatik kontrol
gerekip gerekmediği açık soru, bkz. görev README]`]
**Arka plan kontrolü politikası:** [YER_TUTUCU]

---

## İşten çıkarma incelemesi 🅱️

*Bu bölüm **B kademesindedir** — `isten-cikartma-inceleme` skill'i henüz
taşınmadı. Kaynaktaki FMLA/OWBPA/WARN çerçevesi; 4857 sayılı Kanun'daki ihbar
süreleri (m.17), kıdem tazminatı hesabı, geçerli/haklı fesih ayrımı (m.18-25),
iş güvencesi (m.18-21), fesih bildirimine itiraz ve arabuluculuk zorunluluğu
(7036 sayılı Kanun) ile komple yeniden tasarım gerektiriyor. Bkz.
`.claude/MIGRATION.md` B kademesi bölümü ve `.claude/tasks/is-hukuku/README.md`.
Taşındığında bu bölüm doldurulacak: fesih inceleme tetikleyicileri, standart
kıdem/ihbar uygulaması, yüksek riskli fesih işaretleri (yakın tarihli şikayet,
korumalı izin dönüşü, sendikal faaliyet), arabuluculuk süreci entegrasyonu.*

---

## Çalışma kılavuzu

**Mevcut sürüm:** [YER_TUTUCU — konum, tarih]
**Güncelleme sıklığı:** [YER_TUTUCU]
**Bölge/birim ekleri:** [YER_TUTUCU — hangi şube/bölge/yurt dışı birim için ek
var]

---

## Ücret ve çalışma süresi 🅱️

*Bu bölüm **B kademesindedir** — `ucret-saat-sss` skill'i henüz taşınmadı.
Kaynaktaki FLSA çerçevesi; 4857 sayılı Kanun'daki çalışma süreleri (m.63),
fazla mesai ücreti (%50 zamlı, m.41), fazla sürelerle çalışma (%25 zamlı),
ara dinlenme (m.68), gece çalışması sınırları (m.69), yıllık ücretli izin
(m.53) ile yeniden tasarım gerektiriyor. Bkz. `.claude/MIGRATION.md` B
kademesi bölümü. Taşındığında bu bölüm doldurulacak: muafiyet/muafiyet-dışı
sınıflandırma incelemesi, taşeron/alt işveren sınıflandırma incelemesi, fazla
mesai politikası, bilinen sınıflandırma risk alanları.*

---

## Yargı çevresine özgü eskalasyon kuralları

*Çalışma kılavuzu + fesih notlarından ilk-kurulumda oluşturulur.*

| Yargı çevresi / birim | Özel kurallar | Ne zaman eskale edilir |
|---|---|---|
| [YER_TUTUCU — ör. "Türkiye merkez"] | [YER_TUTUCU] | [YER_TUTUCU] |
| [YER_TUTUCU — ör. yurt dışı şube ülkesi] | [YER_TUTUCU] | [YER_TUTUCU] |

---

## Sistemler

**İK sistemi (HRIS):** [Sistem adı / yok]
**İzin verisi erişimi:** [Hukuk okuma erişimine sahip / elle —
`~/.claude/plugins/config/claude-for-legal-turkish/is-hukuku/izin-kaydi.yaml`]
**Çalışma kılavuzu konumu:** [Drive klasörü / SharePoint / yerel yol]

---

## Eskalasyon

| Konu | Ele alınır | Eskale edilir | Ne zaman |
|---|---|---|---|
| Rutin teklif mektubu | [İK] | [Siz] | Rekabet yasağı, üst düzey, yeni yargı çevresi |
| Performans feshi | [İK + siz] | [BHM] | Yüksek riskli işaretler mevcutsa |
| Toplu işten çıkarma | — | [BHM + dış avukat] | Her zaman |
| İdari başvuru (İŞKUR, Çalışma Bakanlığı, SGK denetimi) | — | [BHM derhal] | Her zaman |

---

## İzin türleri

*İlk-kurulum tarafından doldurulur. Kaynak plugin'de FMLA/CFRA gibi ABD'ye
özgü izin rejimleri sabit örnek olarak veriliyordu; burada profil değişkeni
olarak bırakılmıştır. Aşağıdaki liste TR hukukunda sık görülen izin türleri
için bir başlangıç noktasıdır — şirketin gerçek uygulamasına göre
düzenleyin. `[doğrulanacak — liste ve süreler bir Türk iş hukuku uzmanınca
teyit edilmeli]`*

| İzin türü | Yasal dayanak (taslak) | Süre | Şirket uygulaması |
|---|---|---|---|
| Yıllık ücretli izin | 4857 m.53-60 | Kıdeme göre 14-26 gün | [YER_TUTUCU] |
| Doğum izni (analık) | 4857 m.74 | Doğumdan önce 8, sonra 8 hafta | [YER_TUTUCU] |
| Babalık izni | 4857 m.56 | 5 gün ücretli | [YER_TUTUCU] |
| Ücretsiz izin (doğum sonrası) | 4857 m.74 | 6 aya kadar | [YER_TUTUCU] |
| Hastalık izni / rapor | SGK mevzuatı `[doğrulanacak]` | Rapor süresine göre | [YER_TUTUCU] |
| Mazeret izni (evlilik, ölüm vb.) | 4857 m.56 | 3 gün | [YER_TUTUCU] |
| Sendikal izin | 6356 sayılı STİSK `[doğrulanacak]` | Değişken | [YER_TUTUCU] |
| Diğer / şirkete özgü | — | — | [YER_TUTUCU] |

**Kaynak sistem:** [YER_TUTUCU — İK sistemi adı, hukuğun okuma erişimi var mı]

---

## İzin izleyici ayarları

**ACİL eşiği:** [YER_TUTUCU — varsayılan 3 iş günü]
**BU HAFTA eşiği:** [YER_TUTUCU — varsayılan 7 gün]
**YAKLAŞAN eşiği:** [YER_TUTUCU — varsayılan ~30 gün]

*Ekibiniz daha az ama daha güvenilir uyarı istiyorsa eşikleri daraltın. Daha
erken sinyal istiyorsanız genişletin.*

---

## Soruşturma tercihleri

**Öntanımlı soruşturma türleri:** [YER_TUTUCU — İK (taciz/ayrımcılık/misilleme) |
mali usulsüzlük | yönetici usulsüzlüğü | bildirim/ihbar (whistleblower)]
**Yazılı savunma protokolü:** [YER_TUTUCU — 4857 m.19 kapsamında disiplin
feshi öncesi çalışana savunma hakkı tanınması sürecinin soruşturma akışına
nerede entegre edileceği `[doğrulanacak — bkz. görev README açık sorular]`]
**Sendika/toplu sözleşme bağlamı:** [YER_TUTUCU — soruşturma konusu bir
sendikalı çalışanı ilgilendiriyorsa uygulanacak ek usul `[doğrulanacak]`]

---

## Genişleme tercihleri

**Varsayılan yön:** [YER_TUTUCU — yabancı şirketin Türkiye'ye girişi / Türk
şirketin yurt dışına açılması / ikisi de — bkz. görev README açık sorular]
**Türkiye'ye giriş bağlamı** (yabancı şirket TR'de işe alım yapıyorsa):
çalışma izni (YU-Kart / Uluslararası İşgücü Kanunu), SGK işyeri tescili,
Çalışma ve Sosyal Güvenlik Bakanlığı bildirimleri `[doğrulanacak]`.
**Yurt dışına açılma bağlamı** (TR şirketi yurt dışında işe alım yapıyorsa):
hedef ülkenin iş hukuku, EOR (Employer of Record) sağlayıcı değerlendirmesi,
PE (daimi işyeri) vergi riski — dış avukat brifingi zorunlu.

---

## Tohum belgeler

| Belge | Konum | Tarih | Notlar |
|---|---|---|---|
| Çalışma kılavuzu | [YER_TUTUCU] | | |
| Fesih notu 1 | [YER_TUTUCU] | | |
| Fesih notu 2 | [YER_TUTUCU] | | |
| Fesih notu 3 | [YER_TUTUCU] | | |
...
- Yargı çevresi ayak izi değiştiğinde (yeni ülke, yeni sektör)
- Eskalasyon zinciri değiştiğinde
- İzin türleri veya süreleri değiştiğinde
- Entegrasyonlar (İK sistemi, Slack) bağlandığında veya koptuğunda
- Çalışma kılavuzu güncellendiğinde

Tam ilk-kurulumu yeniden çalıştır: `/is-hukuku:ilk-kurulum --redo`
